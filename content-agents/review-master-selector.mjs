...
const REJECTED_BE_STILL_SHA='1051326a9a05f2912096b5c2e18bf59595b01b0bbca289b7833c12192c68767e'
const validHash=value=>/^[a-f0-9]{64}$/i.test(String(value||''))
export function creativelyRejected(entry){
  if(String(entry?.masterHash||'').toLowerCase()===REJECTED_BE_STILL_SHA)return true
