...
function rejectedVisualMaster(entry) {
  ...
  return stockIds.includes('sunrise-storm-portrait')
}
...
const BANK = [
  { title:'GOD IS NEAR', ref:'Psalm 34:18', script:'When your heart feels heavy, do not mistake pain for abandonment. Psalm 34:18 points us to a God who comes near to the brokenhearted. Bring the hurt to Jesus instead of hiding it. Pray honestly, stay close to Scripture, and take the next faithful step. You are not walking through this moment unseen. Tell God what is heavy without pretending everything is fine. Invite a trusted friend to pray with you. Read the passage slowly and remember that closeness to God is not measured by how cheerful you feel. You can seek practical help while trusting Him. Let today include one honest prayer, one small act of courage, and one reminder that you do not have to hide your pain from the Lord.', caption:'When your heart feels heavy, remember: God is near. Keep bringing it to Jesus. Psalm 34:18. #Jesus #Faith #Prayer #ChristianEncouragement #OneMillionSouls' },
  { title:'FAITH OVER FEAR', ref:'Isaiah 41:10', script:'Fear can be loud, but it does not get the final word. Isaiah 41:10 reminds God’s people not to fear because He is with them and will strengthen them. You may not control every outcome, but you can choose where you place your trust. Fix your heart on Jesus and take today one step at a time. Name the fear and bring that exact concern to God. Courage does not require you to feel fearless. It can mean taking a wise step while your heart is unsettled. Read the verse again and notice the promise of presence and strength. Ask a trusted person to pray with you. Choose the next responsible action instead of trying to solve every possible outcome. Let trust shape what you do today.', caption:'Fear may be loud, but God is with you. Isaiah 41:10. Choose faith today. #FaithOverFear #Jesus #ChristianTikTok #Hope #OneMillionSouls' },
  { title:'DO NOT CARRY TOMORROW', ref:'Matthew 6:34', script:'You were never asked to carry tomorrow before it arrives. In Matthew 6:34, Jesus teaches us not to be consumed by tomorrow’s worries. Give today your faithful attention. Pray about what you cannot control, do what is right in front of you, and trust God with what comes next. Write down what truly belongs to today and set aside the questions you cannot answer yet. Jesus does not forbid wise planning. He teaches us not to let tomorrow consume the present. Pray for the wisdom and strength needed now. Give your attention to the person in front of you and the task you can complete. When worry returns, gently return to this moment and trust God with the next one.', caption:'You do not have to carry tomorrow today. Matthew 6:34. Trust Jesus with the next step. #Jesus #TrustGod #Prayer #Faith #OneMillionSouls' },
  { title:'GRACE IN WEAKNESS', ref:'2 Corinthians 12:9', script:'Your weakness does not disqualify you from God’s work. In 2 Corinthians 12:9, Paul points to Christ’s grace as sufficient and His power as made perfect in weakness. Stop pretending you must be strong every second. Depend on Jesus, ask for help, and let grace meet you where your strength ends. You can admit you are tired and still be faithful. Paul did not pretend struggle was absent. He learned to depend on Christ within it. Ask where you have been hiding your need behind a brave face. Tell God the truth and let a trustworthy person support you. Strength in Christ is not a performance you must manufacture. It is grace you receive while taking the next humble step with Him.', caption:'Your weakness is not the end of your story. Christ’s grace is sufficient. 2 Corinthians 12:9. #Grace #Jesus #Faith #ChristianEncouragement #OneMillionSouls' },
  { title:'KEEP PRAYING', ref:'Luke 18:1', script:'Do not let delay convince you that prayer is pointless. Luke 18:1 introduces Jesus teaching His disciples to pray and not give up. Prayer is not about forcing God to follow our timetable. It is about continuing to trust Him, bringing our needs honestly, and staying faithful while we wait. Persistence may look like returning to a simple prayer after another ordinary day. Sometimes it means asking a friend to pray when you have no words left. Jesus invites us to keep turning toward God, not to treat prayer as a transaction. Bring disappointment honestly. Ask for wisdom to recognize the next faithful action. Keep showing up in Scripture and community while your trust grows through the waiting.', caption:'Do not give up on prayer. Keep trusting Jesus while you wait. Luke 18:1. #Prayer #Jesus #Faith #KeepPraying #OneMillionSouls' },
  { title:'GOD IS STILL WORKING', ref:'Romans 8:28', script:'A difficult chapter does not mean God has stopped working. Romans 8:28 gives believers confidence that God works in all things for the good of those who love Him and are called according to His purpose. We may not understand every moment now, but we can keep trusting Jesus through it. This verse does not say every event is good or that suffering should be minimized. It gives believers reason to trust God’s purpose when the whole picture remains hidden. You may need to grieve, ask for help, make a hard decision, or wait patiently. None of those steps contradict faith. Look for one small opportunity to practice kindness or integrity today. Ask Jesus for wisdom for the next page.', caption:'A hard chapter does not mean God has stopped working. Romans 8:28. Keep trusting Jesus. #Jesus #Faith #Hope #TrustGod #OneMillionSouls' },
  { title:'YOU ARE NOT ALONE', ref:'Hebrews 13:5', script:'Loneliness can make you feel forgotten, but feelings are not the whole story. Hebrews 13:5 reminds believers of God’s promise never to leave or forsake them. Reach out to trusted people, stay connected to Christian community, and remember that Jesus remains faithful even in quiet seasons. God’s presence does not mean you must face every difficulty by yourself. Reach out to a friend, pastor, family member, or another safe person who can listen. If you have been withdrawing, send one message today. If someone else comes to mind, check on them too. Christian community is called to share burdens. Let the promise of God’s faithfulness move you toward honest prayer and real connection.', caption:'You are not forgotten. Stay connected, keep praying, and remember God’s faithfulness. Hebrews 13:5. #Jesus #Hope #Faith #ChristianCommunity #OneMillionSouls' },
  { title:'BE STILL', ref:'Psalm 46:10', script:'Not every battle is won by doing more. Psalm 46:10 calls us to be still and know that God is God. Make space today to stop the noise, pray, listen, and remember who is truly in control. Stillness is not giving up. It is choosing to trust God instead of letting panic lead you. Put your phone aside for a moment and release the need to solve everything immediately. Read the psalm in context and remember that God is a refuge amid trouble. Stillness does not mean ignoring responsibilities or refusing help. It means giving fear less authority than the Lord. Name the worry, offer it to Him, and return to what needs doing. Begin with sixty quiet seconds in an ordinary day.', caption:'Be still. Pray. Remember who God is. Psalm 46:10. #BeStill #Jesus #Prayer #Faith #OneMillionSouls' },
  { title:'LET YOUR LIGHT SHINE', ref:'Matthew 5:16', script:'Your faith was never meant to stay hidden. In Matthew 5:16, Jesus calls His followers to let their light shine so that others may see good works and glorify the Father. Live your faith with humility, kindness, courage, and truth today. Point people to Jesus through both words and actions. You do not need a stage or a large following to live this out. A truthful conversation, a generous choice, or quiet service can reflect the character of Christ. Ask who needs encouragement today. Is there someone you can forgive, welcome, or help without recognition? Jesus directs attention toward the Father, not our image. Let your online words and offline actions tell the same story through practical love.', caption:'Let your light shine today—not for attention, but to point people to God. Matthew 5:16. #LetYourLightShine #Jesus #Faith #ChristianLife #OneMillionSouls' },
  { title:'NOTHING CAN SEPARATE YOU', ref:'Romans 8:38-39', script:'Your circumstances can change quickly, but the love of God in Christ is not fragile. Romans 8:38-39 reminds believers that nothing in creation can separate them from God’s love in Christ Jesus. Hold onto that truth when emotions shift. Jesus remains faithful. Paul names hardship and uncertainty while pointing believers to the enduring love of God. That does not mean you will never feel afraid or disappointed. It means changing feelings do not rewrite the promise of Christ. When the day is difficult, return to what the passage says. Ask someone to pray with you. Keep your eyes on Jesus rather than measuring His love by how easy life feels.', caption:'Circumstances change. God’s love in Christ remains. Romans 8:38-39. #Jesus #GodsLove #Faith #Hope #OneMillionSouls' },
  { title:'START AGAIN WITH GOD', ref:'Lamentations 3:22-23', script:'Yesterday does not have to control today. Lamentations 3:22-23 celebrates God’s steadfast love, mercy, and faithfulness. Confess what needs to change, receive God’s mercy, and begin again with Jesus. A fresh start is not pretending the past never happened; it is choosing faithfulness from here. Mercy does not erase responsibility, but it opens a door to repentance and a different next step. If you need to apologize, do it. If a habit needs to change, ask for help and make a practical plan. If shame replays yesterday, remember God’s faithfulness. You cannot rewrite the past, but you can respond faithfully today. Begin with sincere prayer and one honest decision instead of demanding perfection.', caption:'God’s mercy gives room to begin again. Lamentations 3:22-23. #NewMercies #Jesus #Faith #Grace #OneMillionSouls' },
  { title:'RUN YOUR RACE', ref:'Hebrews 12:1-2', script:'Stop measuring your calling against someone else’s highlight reel. Hebrews 12:1-2 tells believers to run with endurance while fixing their eyes on Jesus. Lay aside what keeps pulling you away from Him. Stay faithful to the race God has placed before you, one obedient step at a time. Comparison can steal attention from the work in front of you. Someone else’s pace is not the measure of your obedience. The passage calls us to lay aside what entangles us and look to Jesus. Ask what is slowing you down: distraction, resentment, fear, or applause. Bring it to God. Encourage another believer instead of competing with them. Take the next faithful step in your calling.', caption:'Run your race with your eyes on Jesus. Hebrews 12:1-2. #Jesus #Faith #Purpose #Endurance #OneMillionSouls' }
]
